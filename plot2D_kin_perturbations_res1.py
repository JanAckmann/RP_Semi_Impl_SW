...
pathlist= ['../data/sheusp_IMPR_SP_FRPPreAll_FRPLap_SPr0V2_RPxAx_DP3_L2Exit_1M3_dt800_res1/'] # '../data/data_ADI_NOTgcr_D6_2M4_RP_res4/'
path_ref='../data/sheusp_DP_L2Exit_1M3_dt800_res1/'
codesQ='T'
codesD='T'
...
for path in pathlist: 
 for time in times:
  for exp in exp_list:
    ...
    plt.savefig('kinetic'+str(exp)+'_rp_res1.png')
    plt.close()
    ...
    clb=plt.colorbar(shrink=0.7)
    clb.set_label(r'$\frac{m}{s}$',fontsize=18, rotation=0)
    plt.savefig('kinetic_diff'+str(exp)+'_rp_res1.png')
    plt.close()
