...
do ID_PREC=7,7,-5
 do DP_Depth_nr=1,3,1
  ...
  !ID_PREC=0
EXP_NAME= 'data/sheusp_IMPR_SP_RPGCR_Prec_DP'//trim(adjustl(Dp_depth_str))//'_L2Exit_1M3_dt200_res4'
...
type(rpe_var)  :: aa(M,1:4), deti, det40, det41, det42, det43, det44, det3_rp,   &
                           ...
                           & d31, d32, d33, d34, d41, d42, d43, d44,       &
                           & s1, s2, s3, s4
type(rpe_var)  :: T_step, Delta_t_I, dn, dni, S_full, util, vtil, swcp
!REAL(Kind=4) :: 
integer :: iter, max_iter, time_scale  !! number of richardson iterations
INTEGER :: I, J, iteration, i2, il1, il2
