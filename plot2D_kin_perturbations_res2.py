...
pathlist= ['../data/sheusp_IMPR_SP_FRPPreAll_FRPLap_SPr0V2_RPxAx_DP3_L2Exit_1M3_dt400_res2/'] # '../data/data_ADI_NOTgcr_D6_2M4_RP_res4/'
path_ref='../data/sheusp_DP_L2Exit_1M3_dt400_res2/'
codesQ='T'
codesD='T'
...
for path in pathlist: 
 for time in times:
  for exp in exp_list:
    ...
    plt.savefig('kinetic'+str(exp)+'_rp_res2.png')
    plt.close()
    ...
    filename =path_ref+'Precon'+str(Precon)+'_' + 'H_exp'+str(exp)+'_time'+str(time)+'_codes_'+codesQ_g+codesD_g+'_bits'+str(23)+'.txt'
    filename_gen =path_ref+'Precon'+str(Precon)+'_' + 'H_exp'+str(exp)+'_time'+str(0)+'_codes_'+codesQ_g+codesD_g+'_bits'+str(23)+'.txt'
    filenameU =path_ref+'Precon'+str(Precon)+'_U_exp'+str(exp)+'_time'+str(time)+'_codes_'+codesQ_g+codesD_g+'_bits'+str(23)+'.txt'
    filenameU_gen =path_ref+'Precon'+str(Precon)+'_' + 'U_exp'+str(exp)+'_time'+str(0)+'_codes_'+codesQ_g+codesD_g+'_bits'+str(23)+'.txt'
    filenameV =path_ref+'Precon'+str(Precon)+'_V_exp'+str(exp)+'_time'+str(time)+'_codes_'+codesQ_g+codesD_g+'_bits'+str(23)+'.txt'
    filenameV_gen =path_ref+'Precon'+str(Precon)+'_' + 'V_exp'+str(exp)+'_time'+str(0)+'_codes_'+codesQ_g+codesD_g+'_bits'+str(23)+'.txt'
    ...
    clb=plt.colorbar(shrink=0.7)
    clb.set_label(r'$\frac{m}{s}$',fontsize=18, rotation=0)
    plt.savefig('kinetic_diff'+str(exp)+'_rp_res2.png')
    plt.close()
