...
do ID_PREC=7,7,-5
 do IRHW = 1,3,2
  ...
  !ID_PREC=0
   EXP_NAME= 'data/sheusp_SP_L2Exit_1M3_dt200_res4_speed'
...
NPRINT = 6490 !216 !797 !797 !int(797*(200.0/240.0)) !864
...
elseif(IRHW==3) then
NT =  6480! 6376 !int(6376*(200.0/240.0)) !12960  
NPRINT= 6490 !797 !797 !int(797*(200.0/240.0)) !864 !DATA NT,NPRINT/12096,864/
!NT = 6376 !int(6376*(200.0/240.0)) !12960  
