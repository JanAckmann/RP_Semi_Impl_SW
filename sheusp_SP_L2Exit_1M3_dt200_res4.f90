...
!! end preconditioning
INTEGER :: IP(n1)
REAL(Kind=4) :: GC1, GC2,error, max_QX_QY, epa
...
REAL(Kind=4) :: err0, rax, beta, errn, x2, y2, T_step
...
call precon(r,x(:,:,1),ax(:,:,1), T_step,  A_c, ps, divi,a11,a12,a21,a22,b11,b22,p0,  &
                &   pfx,pfy,s,n1,n2,ip,ID_PREC, num_of_bits, DP_Depth)
