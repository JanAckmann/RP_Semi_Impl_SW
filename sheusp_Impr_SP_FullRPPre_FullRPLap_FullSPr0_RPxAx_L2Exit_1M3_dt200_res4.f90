...
do ID_PREC=7,7,-5
 do DP_Depth_nr=1,1,1
  do IRHW = 1,3,2
    DP_Depth=DP_Depth_ID(DP_Depth_nr)
   write(Dp_depth_str,*) DP_Depth

  !ID_PREC=0
EXP_NAME= 'data/sheusp_IMPR_SP_FRPPreAll_FRPLap_FullSPr0V2_RPxAx_DP'//trim(adjustl(Dp_depth_str))//'_L2Exit_1M3_dt200_res4'
...
write(*,*)'DP_Depth_RPE', DP_Depth_RPE
RPE_DEFAULT_SBITS =23 !52
restart=.false.
