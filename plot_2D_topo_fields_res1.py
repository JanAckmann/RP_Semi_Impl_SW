...
#pathlist= ['../data/sheusp_DP_L2Exit_1M3_dt800_res1/'] # '../data/data_ADI_NOTgcr_D6_2M4_RP_res4/'
#pathlist= ['../data/sheusp_DP_L2Exit_1M3_dt800_pertH10M2_res1/'] # '../data/data_ADI_NOTgcr_D6_2M4_RP_res4/'
#codesQ='F'
#codesD='F'
