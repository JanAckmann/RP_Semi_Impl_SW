...
do ID_PREC=7,7,-5
 do DP_Depth_nr=3,2,-1
  do IRHW = 1,1,2
    DP_Depth=DP_Depth_ID(DP_Depth_nr)
   write(Dp_depth_str,*) DP_Depth

  !ID_PREC=0
EXP_NAME= 'data/sheusp_IMPR_SP_FRPPreAll_FRPLap_FullSPr0_DP'//trim(adjustl(Dp_depth_str))//'_L2Exit_1M3_dt200_res4_PolAbs'
...
type(rpe_var) :: r_HP_rp_Prec(n1,n2), qu_HP_rp_Prec(n1,n2), pfx_rp_Prec(n1,n2), pfy_rp_Prec(n1,n2)&
      &  , s_rp_Prec(n1,n2), aqu_HP_rp_Prec(n1,n2)
logical :: restart
double precision, external :: norm 
DP_Depth=0
