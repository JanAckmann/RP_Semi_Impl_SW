...
#path='../data/sheusp_IMPR_SP_FRPPreAll_FRPLap_SPr0V2_RPxAx_DP64_L2Exit_1M3_dt400_res2/' # + reduced precisision in conjugacy 
...
#codesD='T'
#codesQ='F'
path='../data/sheusp_DP_L2Exit_1M3_dt400_res2/'
