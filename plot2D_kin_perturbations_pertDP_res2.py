...
pathlist= ['../data/sheusp_DP_L2Exit_1M3_dt400_pertH10M2_res2/'] # '../data/data_ADI_NOTgcr_D6_2M4_RP_res4/'
...
for path in pathlist: 
 for time in times:
  for exp in exp_list:
    ...
    plt.savefig('kinetic'+str(exp)+'_pertDP_res2.png')
    plt.close()
    ...
    clb=plt.colorbar(shrink=0.7)
    clb.set_label(r'$\frac{m}{s}$',fontsize=18, rotation=0)
    plt.savefig('kinetic_diff'+str(exp)+'_pertDP_res2.png')
    plt.close()
