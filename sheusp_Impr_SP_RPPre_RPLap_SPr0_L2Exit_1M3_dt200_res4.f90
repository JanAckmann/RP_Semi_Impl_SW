...
do ID_PREC=7,7,-5
 do DP_Depth_nr=2,3,1
  do IRHW = 1,3,2
    DP_Depth=DP_Depth_ID(DP_Depth_nr)
   write(Dp_depth_str,*) DP_Depth

  !ID_PREC=0
EXP_NAME= 'data/sheusp_IMPR_SP_RPPreAll_RPLap_SPr0_DP'//trim(adjustl(Dp_depth_str))//'_L2Exit_1M3_dt200_res4'
...
! call preconditioner
  ...
  !x_rp(:,:,1)=x_dp(:,:,1)
! calculate Laplacian
   call lapl_depth_rp(qu_HP_rp_Prec(:,:),ax_rp(:,:,1),&
