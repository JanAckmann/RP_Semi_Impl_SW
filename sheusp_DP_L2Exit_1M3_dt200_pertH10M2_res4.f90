...
! the rest
DOUBLE PRECISION :: GMM, SUM1, SUM0, start, finish, pert
...
do ID_PREC=7,7,-5
 do IRHW = 1,3,2
  ...
  !ID_PREC=0
   EXP_NAME= 'data/sheusp_DP_L2Exit_1M3_dt200_pertH10M2_res4'
...
mpfl=999999
elseif(IRHW==1) then
NT = 6376 !6480 !  6376 !int(6376*(200.0/240.0)) !12960  
NPRINT =797 !216 !797 !797 !int(797*(200.0/240.0)) !864 !DATA NT,NPRINT/12096,864/
